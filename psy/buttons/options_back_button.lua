...
return function()
    ...
    if table_ then
        for ob in pairs(table_) do
            ...
            table.insert(target_x_values, ob.pos.x - WINDOW_WIDTH) --Move objects to the right
    ...
    --Iterate through all normal options screen texts and add objects positions (and target values) to the tables
    ...
    if logo then
      ...
      table.insert(target_x_values, logo.pos.x - WINDOW_WIDTH) --Move objects to the right
